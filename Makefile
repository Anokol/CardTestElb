#############################################################################
# Makefile for building: CartTest
# Generated by qmake (3.1) (Qt 6.0.1)
# Project:  CartTest.pro
# Template: app
# Command: P:\6.0.1\mingw81_64\bin\qmake.exe -o Makefile CartTest.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
QMAKE         = P:\6.0.1\mingw81_64\bin\qmake.exe
DEL_FILE      = del
...
QINSTALL      = P:\6.0.1\mingw81_64\bin\qmake.exe -install qinstall
QINSTALL_PROGRAM = P:\6.0.1\mingw81_64\bin\qmake.exe -install qinstall -exe
DEL_FILE      = del
...
Makefile: CartTest.pro ../6.0.1/mingw81_64/mkspecs/win32-g++/qmake.conf ../6.0.1/mingw81_64/mkspecs/features/spec_pre.prf \
		...
		../6.0.1/mingw81_64/mkspecs/features/qml_debug.prf \
